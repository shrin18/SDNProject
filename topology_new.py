...
def topology():
    ...
    lb1 = net.addSwitch( 'lb1', listenPort=6634, mac='00:00:00:00:00:07' )
    lb2 = net.addSwitch( 'lb2', listenPort=6634, mac='00:00:00:00:00:08' )
    id1 = net.addSwitch( 'id1', listenPort=6634, mac='00:00:00:00:00:09' )
    n1 = net.addSwitch( 'n1',listenPort=6634, mac='00:00:00:00:00:0a' )
    fw1 = net.addSwitch ('fw1', listenPort = 6634, mac='00:00:00:00:00:0b')
    fw2 = net.addSwitch ('fw2' ,listenPort = 6634, mac='00:00:00:00:00:0c')
